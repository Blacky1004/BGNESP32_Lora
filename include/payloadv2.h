#ifndef _PAYLOADV2_H_
#define _PAYLOADV2_H_

#include "sds01read.h"
#include "gpsread.h"

//CayenneLPP 1.0 channels Format
//Alle Payloads werden über FPort 1 gesendet
...
class PayloadConverter {
    public:
        ...
        void addStatus(uint64_t uptime, float cputemp, uint32_t mem, uint8_t reset0, uint32_t restarts);
    ...
    private:
        ...
        uint8_t cursor;
    #else
    #error Es wurde kein gültiger Payloadencoder definiert!
    #endif
};

extern PayloadConverter myPayload;
